        ...
        <div className={Style.sectionFlex}>
          <div className={Style.section1}>
            <div className={Style.aboutUs}>
              <div>
                <img src="https://goldsgym.in/uploads/home_icons/gyms.jpg" />
                <h3>150 Gyms</h3>
              </div>

              <div>
                <img src="https://goldsgym.in/uploads/home_icons/cities.jpg" />
                <h3>95 Cities</h3>
              </div>

              <div>
                <img src="https://goldsgym.in/uploads/home_icons/states.jpg" />
                <h3>25 States</h3>
              </div>

              <div>
                <img src="https://goldsgym.in/uploads/home_icons/Website_Personal.jpg" />{" "}
                <h3>Personal Traning</h3>
                <h3>Program</h3>
              </div>

              <div>
                <img src="https://goldsgym.in/uploads/home_icons/Corporate.jpg" />
                <h3>Corporate Wellness </h3>
                <h3> Program</h3>
              </div>

              <div>
                <img src="https://goldsgym.in/uploads/home_icons/Group_Exercise.jpg" />
                <h3>Group Program</h3>
              </div>
            </div>
          </div>
            ...
            <div class={Style.mainDiscription}>
              <div class={Style.discription}>
                <div class={Style.image}>
                  <img src="https://goldsgym.in/assets/images/work.jpg" />
                </div>
                <h3>What Do We Do</h3>
                <br></br>
                <br></br>
